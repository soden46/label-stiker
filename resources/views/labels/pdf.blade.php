...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sticker-logo-image { display: block; max-width: 18mm; max-height: 12mm; margin: 0 auto; }
        ...
        .sticker-product strong { display: block; max-width: 100%; overflow: hidden; font-size: 12pt; line-height: 1.05; font-weight: bold; white-space: nowrap; }
        .sticker-product strong.is-long { font-size: 10pt; }
        ...
        .field-values td { height: 10.5mm; padding: 1mm .7mm; background: #fff; border-right: 1.4mm solid #ffc400; vertical-align: middle; font-size: 7.4pt; line-height: 1.05; font-weight: bold; white-space: nowrap; }
        .field-values td:last-child { border-right: 0; }
        .field-values td.value-po { font-size: 6.7pt; }
        .sticker-fields-bottom { margin-top: 2mm; }
        .sticker-fields-bottom td:nth-child(1) { width: 28%; }
        .sticker-fields-bottom td:nth-child(2) { width: 18%; }
        .sticker-fields-bottom td:nth-child(3) { width: 28%; }
        .sticker-fields-bottom td:nth-child(4) { width: 26%; }
        .sticker-fields-bottom .field-values td { height: 10.5mm; font-size: 6.2pt; }
        .sticker-addresses { width: 86mm; margin-top: 2mm; }
        .sticker-addresses td { height: 13.5mm; padding: .8mm 1mm; background: #fff; border-right: 1.4mm solid #ffc400; text-align: left; vertical-align: top; overflow: hidden; }
        .sticker-addresses td:last-child { border-right: 0; }
        .sticker-addresses strong { display: block; margin-bottom: .8mm; font-size: 4.3pt; line-height: 1; }
        .sticker-addresses span { display: block; max-height: 9.2mm; overflow: hidden; font-size: 4.6pt; line-height: 1.18; }
